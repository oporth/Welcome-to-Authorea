...
%
\begin{align}
  r^{-2} \partial_r(r^2\Gamma \rho v_r) &= 0 \label{eq:continuity} \\ %\partial_t(\Gamma \rho) + 
  r^{-3}\partial_r(r^3(\omega v_\phi v_r \Gamma^2-B_\phi B_r)) &= 0 \label{eq:mphi}\\ %\partial_t(\omega \Gamma^2 v_\phi + \mathcal{S}_\phi) + 
  r^{-2}\partial_r(r^2 (\omega \Gamma^2 v_r + \mathcal{S}_r)) &= 0 \label{eq:energy} \\ %\partial_t(E) + 
  r^{-1}\partial_r(r E_\theta) &= 0 \label{eq:induction} \\ %\partial_t(B_\phi) + 
